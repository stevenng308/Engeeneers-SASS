<?
	...
	class Database{
		...
		private function _buildTable($tableName, $filePath){
			$funcs                      = $this->_getRequiredTables();
			$funcs['items']             = '_itemsFieldTypes';
			$funcs['items_armors']      = '_itemsArmorsFieldTypes';
			$funcs['items_decorations'] = '_itemsDecorFieldTypes';
			$funcs['items_skill_tree']  = '_itemsSkillTreeFieldTypes';
			$funcs['items_weapon']      = '_itemsWeaponFieldTypes';
			$funcs['skill_tree_skills'] = '_itemsSkillTreeSkillsFieldTypes';
			$mysqli                     = $this->getDbConnection();
			if(file_exists($filePath)){
				...
				foreach($row as $field){
					...
					$createQuery .= $field;
					if(method_exists($this, $funcs[$tableName])){
						$createQuery .= $this->$funcs[$tableName]($field);
					} else {
